...
{
    class Loper : Schaakstuk
    {
        public Loper(MainForm.SchaakstukKleur kleur) // Zet kleur van Schaakstuk
        {
            if (kleur == MainForm.SchaakstukKleur.Wit) // Als schaakstuk kleur wit heeft meegekregen
            {
                _SchaakstukkenFoto = Image.FromFile(@"..\..\..\opdracht5AA\loperFotoWit.png");
                kleurSchaakstuk = "wit"; // Geef kleur wit aan schaakstuk om het te defineren.
            }
            else // Als schaakstuk kleur zwart heeft meegekregen
            {
                _SchaakstukkenFoto = Image.FromFile(@"..\..\..\opdracht5AA\loperFotoZwart.png");
        ...
        {
            for (int beweegRichting = 4; beweegRichting < 8; beweegRichting++) // Hiermee bepaal je welke richtingen Koning op kan gaan, namelijk alle richtingen.
            {
